...
<template>
  <div class="max-w-6xl mx-auto px-6 py-10">
    ...
    <section class="mb-12" aria-labelledby="hero-heading">
      <h1 id="hero-heading" class="text-3xl font-bold mb-3">UK Wealth Inequality Dashboard</h1>
      <p class="text-[var(--wl-ink-muted)] max-w-2xl mb-2">
        Open-source, source-backed data on wealth inequality in the United Kingdom. Every chart
        cites its data source with URL and access date.
      </p>
