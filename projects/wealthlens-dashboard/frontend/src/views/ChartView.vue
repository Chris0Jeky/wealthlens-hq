...
const chartConfigs: Record<string, ChartConfig> = {
  ...
  "productivity-pay": {
    ...
    stats: [
      ...
      },
      {
        ...
        unit: "pp",
        description:
          "Productivity gained 32 index points; pay gained only 11 [verify]",
      },
      {
        label: "Lost decade",
        value: "2008–18",
    ...
    stats: [
      {
        ...
        unit: "£",
        description:
          "GDHI per head — more than 5× the lowest area [verify]",
        headline: true,
      },
      {
        label: "UK average",
        value: "24,800",
        unit: "£",
        description: "National GDHI per head in 2023 [verify]",
      },
      {
        ...
        unit: "£",
        description:
          "The lowest GDHI per head in England [verify]",
      },
      {
        ...
        unit: "×",
        description:
          "The income gap between the richest and poorest areas [verify]",
      },
    ],
    toolbar: {
    ...
    stats: [
      {
        ...
        unit: "%",
        description:
          "Income tax (£270bn) + NICs (£180bn) share of selected revenue [verify]",
        headline: true,
      },
      {
        ...
        value: "7",
        unit: "%",
        description: "CGT + IHT + SDLT = roughly £34.5bn combined [verify]",
      },
      {
        ...
        unit: "£bn",
        description:
          "The single largest tax, paid overwhelmingly on earned income [verify]",
      },
      {
        label: "CGT receipts",
        value: "15",
        unit: "£bn",
        description:
          "Despite £billions in capital gains, the tax raises relatively little [verify]",
      },
    ],
    toolbar: {
  ...
  "boe-rates": {
    ...
    stats: [
      ...
      },
      {
        ...
        unit: "%",
        description:
          "Highest CPI inflation in 41 years, October 2022 [verify]",
      },
      {
        ...
        unit: "",
        description:
          "Consecutive rate increases — the fastest tightening cycle since the 1980s [verify]",
      },
    ],
    toolbar: {
  ...
  "child-poverty": {
    ...
    lede: 'After housing costs, <strong>38%</strong> of children in the North East live in relative poverty — the highest regional rate in the UK. Even the lowest region (South East) has a rate of <strong>22%</strong>. Nationally, around 4.2 million children are affected.',
    meta: [
    ...
    stats: [
      ...
      },
      {
        ...
        value: "36",
        unit: "%",
        description: "700,000 children in poverty in the capital [verify]",
      },
      {
      ...
      },
      {
        ...
        unit: "m",
        description:
          "Approximate total children in relative poverty nationally [verify]",
      },
    ],
    toolbar: {
