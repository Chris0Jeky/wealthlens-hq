...
const CHARTS = {
  "wealth-shares": {
    ...
    description: "Top 1% and 10% share of UK net personal wealth since 1820 (WID)",
  },
  "housing-affordability": {
    name: "housing-affordability",
    title: "Housing Affordability — Price-to-Earnings Ratios by Region",
    description: "House price to earnings ratio by region, 1997-2025 (ONS)",
  },
  "cgt-concentration": {
  ...
  "wealth-by-decile": {
    ...
    description: "Total net wealth by decile group in Great Britain (ONS WAS)",
  },
  "productivity-pay": {
    name: "productivity-pay",
    title: "Productivity and Pay",
    description: "UK productivity and real pay indexed over time (ONS Labour Productivity and AWE)",
  },
  "gdhi-by-region": {
    name: "gdhi-by-region",
    title: "Regional Disposable Income",
    description: "Gross disposable household income by UK region (ONS regional accounts)",
  },
  "tax-composition": {
    name: "tax-composition",
    title: "Tax Composition",
    description: "UK tax revenue composition by source (HMRC and OBR)",
  },
  "boe-rates": {
    name: "boe-rates",
    title: "Bank of England Rates",
    description: "Bank Rate history and monetary policy changes (Bank of England)",
  },
  "child-poverty": {
    name: "child-poverty",
    title: "Child Poverty",
  ...
  "generational-wealth": {
    ...
    description: "Wealth distribution across generations in Great Britain (ONS WAS)",
  },
