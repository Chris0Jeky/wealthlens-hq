...
export const DECILE_DATA: readonly DecileInfo[] = [
  ...
  },
  {
    ...
    upperBound: 990_000,
    median: 829_950,
    rangeLabel: "£669,900 – £990,000",
  },
  {
    decile: 9,
    lowerBound: 990_000,
    upperBound: 1_480_000,
    median: 1_235_000,
    rangeLabel: "£990,000 – £1,480,000",
  },
  {
    decile: 10,
    lowerBound: 1_480_000,
    upperBound: null,
    median: 2_500_000,
    rangeLabel: "£1,480,000+",
  },
]
...
export function getContext(decile: number): string {
  ...
  return (
    messages[decile] ?? `You have more wealth than roughly ${householdsBelow} in 10 UK households.`
  )
}
