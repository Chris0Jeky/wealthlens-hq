...
<template>
  ...
  >
    ...
    >
      <path
        d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0Zm-.75 4.75a.75.75 0 0 1 1.5 0v3.5a.75.75 0 0 1-1.5 0v-3.5ZM8 12a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z"
      />
    </svg>
    <!-- Dot for loading -->
    <span v-else class="inline-block h-2 w-2 rounded-full bg-gray-400" aria-hidden="true"></span>
