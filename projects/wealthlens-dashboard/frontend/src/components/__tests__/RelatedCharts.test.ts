...
const RouterLinkStub = defineComponent({
  ...
  setup(props, { slots }) {
    return () =>
      h(
        'a',
        { href: props.to, class: 'related__card' },
        slots.default?.(),
      )
  },
})
...
const sampleCharts = [
  { domain: 'Wealth', title: 'Household wealth', finding: 'Key finding <b>here</b>', to: '/charts/household-wealth' },
  { domain: 'Housing', title: 'Affordability ratio', finding: 'Another finding', to: '/charts/housing', sparkType: 'bar' as const },
