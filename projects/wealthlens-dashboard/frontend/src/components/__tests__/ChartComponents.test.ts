...
const chartComponents = [
  ...
  {
    name: "HousingAffordabilityChart",
    component: HousingAffordabilityChart,
  ...
  {
    name: "GenerationalWealthChart",
    component: GenerationalWealthChart,
    dataset: "generational-wealth",
  },
] as const
...
describe("Chart components", () => {
  ...
  describe("WealthSharesChart happy path", () => {
    it("renders VChart when data loads successfully", async () => {
      ...
      // WCAG 1.1.1: an accessible data-table fallback renders with the data.
      ...
      mockRows.value = [
        {
          ...
          sdlt_bn: 12,
          work_taxes_bn: 421,
          wealth_taxes_bn: 33.6,
          total_selected_bn: 454.6,
          work_pct: 92.6,
          wealth_pct: 7.4,
