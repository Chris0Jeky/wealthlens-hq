...
describe("ProvenancePanel", () => {
  it("renders each consumed source with its citation links", () => {
    ...
    expect(wrapper.find("section").attributes("aria-labelledby")).toBe(h2.attributes("id"))
  ...
  it("disambiguates two same-host citation links (WCAG 2.4.4)", () => {
    const sameHost: ConsumedAssumption = {
      ...
      source_urls: ["https://doi.org/10.1257/pol.20200258", "https://doi.org/10.1257/app.20220615"],
    }
