...
<template>
  ...
  <div v-else>
    <div
      role="img"
      :aria-label="`Dual-axis chart showing capital gains concentration by gain band. ${headlineInsight}. Blue bars show each band's share of total gains; red line shows cumulative concentration from the top.`"
      class="w-full"
    >
      <VChart
        class="w-full"
