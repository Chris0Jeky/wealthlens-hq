...
import { OG_METADATA } from "../src/constants/ogMetadata";
...
async function loadFonts() {
    ...
    if (missingFonts.length > 0) {
        ...
        throw new Error(`Missing vendored OG font files in ${FONTS_DIR}: ${missing}. ` +
 ...
 */
function buildChartLayout(metadata) {
    return {
        type: "div",
        props: {
            style: {
                        ...
                        children: [
                            ...
                            // Mission statement
                            {
                                ...
                                props: {
                                    ...
                                    children: "Making UK wealth inequality data accessible, interactive, and impossible to ignore.",
                                },
                            },
                        ],
                    },
 ...
 */
async function renderToPng(layout, fonts) {
