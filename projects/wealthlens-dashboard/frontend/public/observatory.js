...
const config = {"id":"wealthlens","project":{"events":["page.view","app.ready","app.error","action.requested","action.completed","action.failed","duration.ms"],"routes":["home"],"releases":["unattributed"],"measurements":["duration.ms"]},"origin":"https://chris0jeky.github.io","endpoint":"","scopePath":"/wealthlens-hq/","release":"unattributed","route":"home","clicks":[]};
