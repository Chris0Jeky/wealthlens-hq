...
**Start with mySociety, Common Wealth, CenTax, Tax Justice Network and Equality Trust** — these five sit at the intersection of high tech leverage, real receptiveness to volunteers, and direct relevance to wealth inequality. The wider ecosystem is large (40+ orgs) but is held together by a small funder pool (JRCT, JRF, Friends Provident, Nuffield, Trust for London) and a recurring cast of campaigners. Embedding well means picking two or three nodes and **building real artefacts** — in this space, people trust artefacts more than credentials.

The UK has no formal "Code for Britain" or PIT-UK fellowship — mySociety is the de facto Code for America equivalent. The genuine grant routes for an engineer building tools sit at the Joseph Rowntree Reform Trust (political/transparency tools), Software Sustainability Institute (research software), Mozilla Foundation (independent track), and JRF's Emerging Futures programme.

**The single biggest engineering gap in the UK ecosystem is a clean, open, reproducible wealth-distribution and tax-reform calculator on top of HMRC/ONS/Companies House — almost every campaigning org would use it, and nobody currently owns it.**
...
## Three design principles that should run through every artefact

These principles are non-negotiable for an engineer working in this space and should shape every project decision:

1. **Don't just publish findings — publish a way to interrogate them.** The UK has excellent analysis, but it still leans heavily on PDFs, blogposts and static charts. The strongest US analogues (ProPublica's Nonprofit Explorer, EPI's State of Working America Data Library, Opportunity Atlas) succeed because they turn one-off reporting or academic work into public databases, searchable records, historical data libraries and place-based interactive tools. Build the interrogation layer, not another report.

2. **In this ecosystem, artefacts beat credentials.** Publish something open-source, reproducible and useful *before* asking for access. A working chart, a transparent methodology note and a deployable embed count for more than saying you "want to help."

3. **Reduce adoption friction to near zero.** When you show a tool to a campaign organisation, lead with: a deployable widget, an iframe, a PNG export, a data download, and a methodology page. The target audience for a v1 should be a campaign comms lead, not an economist.
...
## The four-tier accessibility map

A practical lens on where to invest time, by accessibility-to-impact ratio:

- **Tier A — high influence, lower casual accessibility.** Resolution Foundation, IFS, IPPR, JRF, Oxfam GB, LSE III, UCL IIPP. Worth approaching once you have something polished, documented and politically legible. "Second deployment" partners, not where to start with a rough v0.1.
- **Tier B — specialist orgs with strong agendas and an obvious product gap.** Tax Justice UK, Patriotic Millionaires UK, Common Wealth, Positive Money, Equality Trust, NEF, Tax Justice Network, Demos. This is where an engineer can move fastest — sharp narratives, campaign moments, report pipelines, but few obvious signs of large in-house product teams.
- **Tier C — network builders, education platforms and movement infrastructure.** Rethinking Economics, Fabian Society, Progressive Economy Forum, Warwick CAGE. Valuable for ideas, convening, events, citations and introductions, not for direct product adoption.
- **Tier D — engineer-native civic-tech.** mySociety, Democracy Club, DataKind UK, Full Fact, ODI. Best places to build reputational credibility as an engineer in public-interest tech, even when their formal missions are broader than wealth inequality alone.

## Quick-reference table: the highest-leverage organisations

| Organisation | Tier | Access signal | Best engineering offer |
|---|---|---|---|
| **mySociety** | D | Active jobs page, 403 public repos, volunteer cohort for WhoFundsThem | SocietyWorks Developer role (£42–52k, open until 31 May 2026); PRs on `theyworkforyou` / `local-intelligence-hub` |
| **Common Wealth** | B | "Not hiring" but ships strong interactives (Who Owns Britain?, Right to Buy calculator) | Pitch open-sourcing the data layer, automating Companies House/Land Registry ingest, modernising viz stack |
| **Tax Justice Network** | B | Active GitHub org, named in-house developer | Small PR on `swift_codes_scraper`; rebuild Stata indices as proper ETL |
| **Equality Trust** | B | Volunteer page explicitly invites skill offers | Modernise the Obscene Wealth Simulator; build #1forEquality SED tracker |
| **CenTax** | A→B | Small, fast-growing, no public code | Reproducible open-source tax-reform simulator on HMRC microdata, anchored to Budget moments |
| **Tax Justice UK** | B | Faiza Shaheen new ED, 54k supporters, no technologists | Wealth-tax revenue calculator; MP tax-vote scorecard; constituency revenue map |
| **Patriotic Millionaires UK** | B | High media moments, no tech team | "What could £X wealth tax fund in your constituency?" microsite for Davos 2027 |
| **Oxfam GB inequality team** | A→B | Max Lawson notoriously responsive; Davos pipeline is in spreadsheets | Reproducible R/Python/Quarto pipeline; interactive billionaire-wealth dashboard |
| **Democracy Club** | D | 117+227 open issues, Slack open via email | Pick a "needs help" issue on `UK-Polling-Stations` or `yournextrepresentative` |
| **INET Oxford Complexity Economics** | A | Active GitHub orgs, multi-disciplinary culture | PR on `housing-model` or Economic Simulation Library; pitch macro-ABM tooling |
| **Resolution Foundation** | A | Treasury-orbit; no data-science team | Approach via paid Research Associate; or pitch into Resolution Ventures WorkerTech Fund |
| **IPPR / CEJ** | A | Close to Labour govt; no public GitHub | Applied policy tools on housing, regional inequality, wealth distribution |
| **IFS** | A | Research-only, no advocacy; TAXBEN is closed | Pitch a publisher-grade explorer — methodologically tight only |
| **JRF (as funder, not employer)** | A | Sophia Parker leads Emerging Futures (£50–100m) | Get on Emerging Futures radar with a built artefact; pitch via delivery-partner model |
| **DataKind UK** | D | Volunteer applications **currently paused** | Sign up to newsletter for reopening; track DataDive weekends |
| **Full Fact** | D | Stable engineering team, occasional hiring | Monitor careers page; PR on the 31 public utility repos |
| **38 Degrees** | B | In-house tech team but no public GitHub | Monitor home.38degrees.org.uk/careers; emailtheteam@ with scoped offer |
| **Rethinking Economics** | C | "Writing a blog, recording a podcast… or anything else" welcomed | Local-groups directory tool; Rethinking Econ 101 improvements |
| **Positive Money** | B | Research-led, no engineers | BoE collateral framework / fossil-fuel finance viz |

## Tier 1 deep dives: where engineering leverage is highest
...
Six staff, £558k income (2024), founded by Kate Pickett and Richard Wilkinson. Funded by JRCT (core), Barrow Cadbury, Trust for London (£29,875 restricted London SED), Friends Provident, Health Foundation, plus individual donors. Their volunteer page says explicitly: *"as a very small charity we welcome support from people willing to offer their time and skills."* They already use pro-bono SaaS donations (Slack, Google for Non-Profits, Canva). Recent hiring for a Senior Digital Engagement Officer signals a real digital-distribution need.
...
### Useful "bridge" people to follow inside institutions

These are the people who sit between research, communications and product-like work, and are most likely to understand why a reusable open-source data tool matters:

- **Harry Quilter-Pinner** (IPPR ED) and **Carsten Jung** (IPPR Senior Economist on AI/macro)
- **Josh Ryan-Collins** — straddles UCL IIPP and Progressive Economy Forum
- **Sophia Parker** (JRF Emerging Futures) and **Aleks Collingwood** (JRF engagement lead)
- **Alex Parsons** (mySociety), **Peter Keeling** (Democracy Club data lead), **Sym Roe** (Democracy Club strategy)
- **Alex Cobham** (TJN CEO) — Oxford-based, very responsive on Twitter
- **Mat Lawrence** (Common Wealth founder, @DantonsHead) — active and approachable
- **Max Lawson** (Oxfam Head of Inequality Policy) — famously responsive
- **Andy Summers** (CenTax co-director) — London-based, the right pitch target for tax-reform tooling
...
| Autumn 2026 | Party conference season | Tools should be ready *before* conference recess; campaign groups distribute heavily here |
...
The UK has plenty of strong analysis but lacks the **durable public product layer** that makes hard questions easy for non-experts to explore on mobile, embed in campaign pages, and circulate as a single link. The US analogues succeed not by publishing better PDFs but by turning one-off reporting or academic work into public databases, searchable records, historical data libraries and place-based interactive tools.

**ProPublica** (github.com/propublica) is the gold standard — the Nonprofit Explorer turned IRS Form 990 data into an API the IRS doesn't offer. UK parallel: wrap Companies House + Charity Commission + Land Registry into a properly queryable Charity/Corporate Explorer with a UBO graph. **World Inequality Lab** (github.com/WIDworld) maintains `wid-world` (pipeline), `wid-r-tool`, `wid-stata-tool`, `wid-bulk-downloader`, and crucially **`gpinter`** (generalised Pareto interpolation) — directly applicable to reconstructing fine-grained UK distributions from HMRC's coarse public tables. **EPI's State of Working America Data Library** is a replicable template for a "State of Working Britain" combining ASHE, HMRC Personal Incomes Table 3.1a, and FRS. **Opportunity Insights / Opportunity Atlas** shows what happens when rigorous research becomes a place-based public interface and downloadable data repository. **Inequality.org / IPS** shows the power of consistent editorial framing — the UK equivalent (Equality Trust) is tech-light by comparison and has obvious room to grow. **Oxfam's Davos pipeline** is in spreadsheets — exactly the gap a UK engineer could close.

Adjacent tools worth knowing: **OpenCorporates** (220m+ companies, free for journalists/NGOs as Permitted Users), **OCCRP Aleph** (400m+ entities including leaks), **Open Ownership** (BODS data standard), and **ICIJ's Offshore Leaks Database**.

**The UK gaps that are most ripe to fill:** a public "wealth explorer"; a searchable "who benefits from this tax relief?" tool; a neighbourhood- or constituency-level ownership / housing / wealth story; a reusable open API for campaign groups and journalists; and embed-ready mini-charts that allies can drop into petitions, Substacks and briefings.
...
The 30/60/90-day frame works alongside the week/month/quarter sequencing below — both are aimed at the same outcome: turning one high-quality public artefact into one trusted institutional reuse, then into recognition.
...
**Do this month (≈30 days).** Pick **one substantive artefact** and start it publicly on GitHub — the best candidate is the wealth-tax revenue calculator (HMRC SPI Table 3.1a + WAS Round 8 + WID + `gpinter` for distributional reconstruction) tied to the Autumn Budget 2026 moment. Publish as open source from day one. Build it so a comms lead — not an economist — can use it. Open a small useful PR on TJN's `swift_codes_scraper` (or replace it with a maintained equivalent); open a PR on mySociety's `local-intelligence-hub`; engage one issue on Democracy Club's `UK-Polling-Stations`. Attend the LSE III Inequalities Seminar Series (Tuesdays) and CenTax events.

**Do this quarter (≈60–90 days).** Email Mat Lawrence (Common Wealth) and Max Lawson (Oxfam) with a specific proposal anchored to your built artefact — lead with a deployable widget, iframe, PNG export, data download and methodology page. Pitch Andy Summers (CenTax) on extending the calculator with HMRC microdata. Attend UCL IIPP Forum 16–17 June 2026. Apply to JRRT Larger Grants — September 2026 round (outline by 24 August). Start preparing an SSI Fellowship application for the October 2026 deadline. Present through TICTeC / mySociety networks. The most realistic path to recognition: **one public artefact → one trusted institutional reuse → one talk / article / event appearance → ongoing requests.**
...
A few parts of the map are less complete than the rest. **38 Degrees** is clearly a major campaigning platform but its volunteer-engineering routes and recent hiring detail are thinner than the Tier 1 orgs. The **IPPR Centre for Economic Justice** is treated here as a node within IPPR rather than a standalone organisation, which is how IPPR itself presents it. The Oxford Martin inequality programme is important intellectually but plainly archived, so a poor target for current outreach. Jobs and volunteer openings move fast: for groups such as Full Fact, DataKind UK, Democracy Club, Equality Trust, Tax Justice Network and ODI, the *opportunity signal* is current, but the exact opening may change quickly — check directly before relying on any specific role mentioned above.
