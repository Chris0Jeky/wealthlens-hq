---
name: codex-repo-onramp
description: Orient to WealthLens HQ before editing. Use for broad/ambiguous requests, session setup, or high-autonomy orientation.
---

# WealthLens HQ — Codex Repo Onramp

## When to use

- First task in a session
- Broad or ambiguous request
- Crossing into an unfamiliar area of the repo
...
7. If the task is code-related, check `autodoc/AGENT_INDEX.md` for code seams.
